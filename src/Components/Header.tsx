...
function Header() {
    ...
    const toggleSearch = () => {
        ...
        // 아래 방식은 어떤 결과로 인해 여러 애니메이션이 동시에 변경이 되어야 할 때 유용하다.
        if (searchOpen) {
    ...
    useEffect(() => {
        ...
        // navHeight! 쓴 이유 // 'navHeight' is possibly 'undefined' 에러 메세지
        // 때때로 타입스크립트 컴파일러는 어느 시점에서 확실한 자료형인지 결정할수 없습니다.
    ...
    return (
        <Nav ref={nav} variants={navVariants} animate={navAnimation} initial="top">
            <Col>
                <Logo variants={logoVariants} whileHover="active" initial="normal" xmlns="http://www.w3.org/2000/svg" width="1024" height="276.742" viewBox="0 0 1024 276.742">
